...
resourcename="sushirestaurantdatamodel"  # lower case, only
resourcegroup="sushirestaurantdatamodel_rg"
...
# git clone https://github.com/apilogicserver/sushirestaurantdatamodel.git
# cd sushirestaurantdatamodel
...
az group create --name sushirestaurantdatamodel_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group sushirestaurantdatamodel_rg --sku S1 --is-linux
az container create --resource-group sushirestaurantdatamodel_rg --name sushirestaurantdatamodel --image apilogicserver/sushirestaurantdatamodel:latest --dns-name-label sushirestaurantdatamodel --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//sushirestaurantdatamodel.westus.azurecontainer.io:5656'
